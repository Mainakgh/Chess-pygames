...
background = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/board.png").convert()
#Load an image with all the pieces on it:
pieces_image = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/Chess_Pieces_Sprite.png").convert_alpha()
circle_image_green = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/green_circle_small.png").convert_alpha()
circle_image_capture = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/green_circle_neg.png").convert_alpha()
circle_image_red = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/red_circle_big.png").convert_alpha()
greenbox_image = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/green_box.png").convert_alpha()
circle_image_yellow = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/yellow_circle_big.png").convert_alpha()
circle_image_green_big = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/green_circle_big.png").convert_alpha()
yellowbox_image = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/yellow_box.png").convert_alpha()
#Menu pictures:
withfriend_pic = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/withfriend.png").convert_alpha()
withAI_pic = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/withAI.png").convert_alpha()
playwhite_pic = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/playWhite.png").convert_alpha()
playblack_pic = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/playBlack.png").convert_alpha()
flipEnabled_pic = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/flipEnabled.png").convert_alpha()
flipDisabled_pic = pygame.image.load("C:/Users/Mainak/Desktop/ToyGame-Hackathon-main/Media/flipDisabled.png").convert_alpha()
